...
public class PlanAdvisor extends AbstractAdvisor {
    ...
    public PlanAdvisor(ChatClient.Builder chatClientBuilder, ToolCallbackProvider toolCallbackProvider, ObjectMapper objectMapper, int order) {
     ...
     */
    public record AnalysisRequest(String query, List<String> availableTools) {
     ...
     */
    public record QueryPlan(String summary, String actionableSteps, String clarificationQuestions, String additionalConsiderations) {
